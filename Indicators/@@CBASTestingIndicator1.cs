...
{
    public class CBASTestingIndicator1 : Indicator
    {
        [NinjaScriptProperty]
        [Range(0.5, 10)]
    ...
    private int plotBull;
    private int plotBear;
    private int plotPullback;
    ...
    protected override void OnStateChange()
    {
        if (State == State.SetDefaults)
        {
            ...
            AddPlot(Brushes.LimeGreen, "BullSignal");
            AddPlot(Brushes.Red, "BearSignal");
            AddPlot(Brushes.LimeGreen, "Pullback");
        ...
        else if (State == State.DataLoaded)
        {
            ...
            Plots[plotBull].Width = 3;
            Plots[plotBear].Width = 3;
            Plots[plotPullback].Width = 2;
        }
    }
    ...
    protected override void OnBarUpdate()
    {
        ...
        if (bull)
        {
            ...
            Values[plotBull][0] = y1;
        }
        if (bear)
        {
            double y2 = High[0] + atr30[0] * 2.0;
            Values[plotBear][0] = y2;
        }
...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private CBASTestingIndicator1[] cacheCBASTestingIndicator1;
		public CBASTestingIndicator1 CBASTestingIndicator1(double sensitivity, bool emaEnergy, int keltnerLength, int atrLength, int rangeMinLength, double rangeWidthMult, int rangeAtrLen)
		{
			return CBASTestingIndicator1(Input, sensitivity, emaEnergy, keltnerLength, atrLength, rangeMinLength, rangeWidthMult, rangeAtrLen);
		}

		public CBASTestingIndicator1 CBASTestingIndicator1(ISeries<double> input, double sensitivity, bool emaEnergy, int keltnerLength, int atrLength, int rangeMinLength, double rangeWidthMult, int rangeAtrLen)
		{
			if (cacheCBASTestingIndicator1 != null)
				for (int idx = 0; idx < cacheCBASTestingIndicator1.Length; idx++)
					if (cacheCBASTestingIndicator1[idx] != null && cacheCBASTestingIndicator1[idx].Sensitivity == sensitivity && cacheCBASTestingIndicator1[idx].EmaEnergy == emaEnergy && cacheCBASTestingIndicator1[idx].KeltnerLength == keltnerLength && cacheCBASTestingIndicator1[idx].AtrLength == atrLength && cacheCBASTestingIndicator1[idx].RangeMinLength == rangeMinLength && cacheCBASTestingIndicator1[idx].RangeWidthMult == rangeWidthMult && cacheCBASTestingIndicator1[idx].RangeAtrLen == rangeAtrLen && cacheCBASTestingIndicator1[idx].EqualsInput(input))
						return cacheCBASTestingIndicator1[idx];
			return CacheIndicator<CBASTestingIndicator1>(new CBASTestingIndicator1(){ Sensitivity = sensitivity, EmaEnergy = emaEnergy, KeltnerLength = keltnerLength, AtrLength = atrLength, RangeMinLength = rangeMinLength, RangeWidthMult = rangeWidthMult, RangeAtrLen = rangeAtrLen }, input, ref cacheCBASTestingIndicator1);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.CBASTestingIndicator1 CBASTestingIndicator1(double sensitivity, bool emaEnergy, int keltnerLength, int atrLength, int rangeMinLength, double rangeWidthMult, int rangeAtrLen)
		{
			return indicator.CBASTestingIndicator1(Input, sensitivity, emaEnergy, keltnerLength, atrLength, rangeMinLength, rangeWidthMult, rangeAtrLen);
		}

		public Indicators.CBASTestingIndicator1 CBASTestingIndicator1(ISeries<double> input , double sensitivity, bool emaEnergy, int keltnerLength, int atrLength, int rangeMinLength, double rangeWidthMult, int rangeAtrLen)
		{
			return indicator.CBASTestingIndicator1(input, sensitivity, emaEnergy, keltnerLength, atrLength, rangeMinLength, rangeWidthMult, rangeAtrLen);
		}
	}
